...
import View.Modals.ModalEmpleados;
import View.Modals.ModalUsuarios;
 ...
 * @author Royss
 */
public class PageUsuarios extends java.awt.Panel {
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ModalUsuarios mUsuarios = new ModalUsuarios(new FormMenu(), true);
        mUsuarios.pack();
