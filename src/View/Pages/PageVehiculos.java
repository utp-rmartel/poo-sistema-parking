...
import View.Modals.ModalVehiculos;
 ...
 * @author Royss
 */
public class PageVehiculos extends java.awt.Panel {
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ModalVehiculos mVehiculos = new ModalVehiculos(new FormMenu(), true);
        mVehiculos.pack();
        mVehiculos.setLocationRelativeTo(null);
